...
import { comments as dummyComments } from "../utils/dummyData";
...
const PostComments = ({ postId }) => {
  const { user } = useStore();
  const [comments, setComments] = useState(dummyComments); // Renamed 'comments' to 'dummyComments' for clarity
  ...
  return (
    <div className="w-full py-10">
      ...
      {user?.token ? (
        <form className="flex flex-col mb-6" onSubmit={handleAddComment}>
          <textarea
            name="desc"
